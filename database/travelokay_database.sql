...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3552397827ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=travelokay_database&table=users">`travelokay_database`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=travelokay_database&table=trains">`travelokay_database`.`trains`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=travelokay_database&table=traintrips">`travelokay_database`.`traintrips`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=travelokay_database&table=airlines">`travelokay_database`.`airlines`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=travelokay_database&table=airplanes">`travelokay_database`.`airplanes`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=travelokay_database&table=airports">`travelokay_database`.`airports`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=travelokay_database&table=buscompanies">`travelokay_database`.`buscompanies`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=travelokay_database&table=buses">`travelokay_database`.`buses`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=travelokay_database&table=busstations">`travelokay_database`.`busstations`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=travelokay_database&table=bustrips">`travelokay_database`.`bustrips`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="54747032494b4042542d4c4a5449703b">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="travelokay_database" targettable="users">
            ...
            Queried time
                            ...
                            <span class="query">UPDATE users SET password = MD5(&#039;admin1&#039;) WHERE user_id = 1;</span>
                        </div>
            ...
            Queried time
                            ...
                            <span class="query">UPDATE users SET password = MD5(&#039;user1&#039;) WHERE user_id = 2;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="travelokay_database" targettable="users">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">UPDATE users SET password = MD5(&#039;flightpartner1&#039;) WHERE user_id = 3;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="travelokay_database" targettable="users">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">UPDATE users SET password = MD5(&#039;trainpartner1&#039;) WHERE user_id = 4;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="travelokay_database" targettable="users">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">UPDATE users SET password = MD5(&#039;buspartner1&#039;) WHERE user_id = 5;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="travelokay_database" targettable="users">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">UPDATE users SET password = MD5(&#039;hotelpartner1&#039;) WHERE user_id = 6;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="travelokay_database" targettable="users">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">UPDATE users SET password = MD5(&#039;tourpartner1&#039;) WHERE user_id = 7;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="travelokay_database" targettable="users">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="travelokay_database" targettable="traintrips">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `traintrips`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="travelokay_database" targettable="trains">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `trains`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="travelokay_database" targettable="users">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="travelokay_database" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">DROP TABLE `airlines`, `airplanes`, `airports`, `buscompanies`, `buses`, `busstations`, `bustrips`, `flights`, `hotels`, `orders`, `rooms`, `seats`, `stations`, `tours`, `tourschedules`, `traintrips`;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="travelokay_database" targettable="users">
                            <div class="action_content">
