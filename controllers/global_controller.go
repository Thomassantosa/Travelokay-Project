...
// 	hotelCity := r.URL.Query()["hotel_city"]
// 	if hotelCity != nil {
// 		query += " WHERE hotel_city = " + hotelCity[0]
// 	}
// 	log.Println(hotelCity)
// 	rows, err := db.Query(query)

// 	if err != nil {
// 		log.Println("gagal err")
// 		SendErrorResponse(w, 400)
// 		return
// 	}
